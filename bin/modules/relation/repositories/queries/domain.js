...
class Relation {
  ...
  constructor(db) {
    ...
    async listRelation(payload) {
        const ctx = 'domain-getRelation';
    ...
    async getRelation(payload) {
        ...
        if (err) return wrapper.error(new ConflictError('Relation not found'));
